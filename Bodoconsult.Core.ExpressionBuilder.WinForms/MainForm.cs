...
using Bodoconsult.Core.ExpressionBuilder.WinForms.Controls;
using Bodoconsult.Core.ExpressionBuilder.WinForms.Models;

namespace Bodoconsult.Core.ExpressionBuilder.WinForms
{
	...
	public partial class MainForm : Form
	{
			...
			get
			{
                ...
                _people = new List<Person>
                {
                    new Person
                    {
                        ...
                        Birth = new Person.BirthData {Date = new DateTime(1979, 2, 28), Country = "USA"},
                        Employer = company
                    },
                    new Person
                    {
                        ...
                        Birth = new Person.BirthData {Date = new DateTime(1985, 9, 5), Country = " "}
                    },
                    new Person
                    {
                        Name = "Wade Wilson",
                        Gender = PersonGender.Male,
                        Birth = new Person.BirthData {Date = new DateTime(1973, 10, 9), Country = "USA"}
                    },
                    new Person
                    {
                        Name = "Jessica Jones",
                        Gender = PersonGender.Female,
                        Birth = new Person.BirthData {Date = new DateTime(1980, 12, 20), Country = "USA"}
                    },
                    new Person
                    {
                        Name = "Jane Jones",
                    ...
                    new Person
                    {
                        Name = "Fulano Silva",
                        Gender = PersonGender.Male,
                        Birth = new Person.BirthData {Date = new DateTime(1983, 5, 10), Country = "BRA"},
                        Employer = company
                    },
		...
		{
            var control = new UcFilter {TypeName = typeof(Person).FullName};
